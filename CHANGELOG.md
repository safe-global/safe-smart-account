...
Solidity compiler: [0.7.6](https://github.com/ethereum/solidity/releases/tag/v0.7.6) (more info see issue #251)
...
File: contracts/examples/guards/ReentrencyTransactionGuard.sol
Note: **This contract is meant as an example to demonstrate how to facilitate a guard. This should not be used in production without further checks.**
Expected behaviour:
