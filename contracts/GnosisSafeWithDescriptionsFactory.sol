...
contract GnosisSafeWithDescriptionsFactory {
    ...
    event GnosisSafeWithDescriptionsCreation(address indexed creator, GnosisSafeWithDescriptions gnosisSafe, address[] owners, uint8 required);
        ...
        returns (GnosisSafeWithDescriptions gnosisSafe)
    {
        ...
        GnosisSafeWithDescriptionsCreation(msg.sender, gnosisSafe, owners, required);
    }
}
