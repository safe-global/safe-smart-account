...
contract CompatibilityFallbackHandler is TokenCallbackHandler, ISignatureValidator, HandlerContext {
    ...
    /**
     * @dev The Solidity ABI function selector for the {simulate} function.
     *      This constant is currently unused, but left to not break compatibility with contracts that
     *      inherit from the {CompatibilityFallbackHandler}.
     */
