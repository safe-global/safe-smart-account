...
describe("ModuleManager", async () => {
    ...
    describe("enableModule", async () => {
        ...
        it('emits event for new module', async () => {
            ...
            await expect(
                await safe.getModulesPagined(AddressZero, 10)
        ...
        it('can enable multiple', async () => {
            ...
            await expect(await safe.getModulesPagined(AddressZero, 10)).to.be.deep.equal([user1.address])
            ...
            await expect(await safe.getModulesPagined(AddressZero, 10)).to.be.deep.equal([user2.address, user1.address])
        })
    })
    ...
    describe("disableModule", async () => {
        ...
        it('emits event for disabled module', async () => {
            ...
            await expect(await safe.getModulesPagined(AddressZero, 10)).to.be.deep.equal([user2.address])
            ...
            await expect(await safe.getModulesPagined(AddressZero, 10)).to.be.deep.equal([])
        })
    })
