...
contract('GnosisSafeTeamEdition', function(accounts) {
    ...
    let executeTransaction = async function(subject, accounts, to, value, data, operation, opts) {
        ...
        let executeDataWithoutSignatures = gnosisSafe.contract.execTransaction32785586.getData(to, value, data, operation, 0, 0, 0, 0, 0, "0x")
        ...
        let tx = await gnosisSafe.execTransaction32785586(to, value, data, operation, 0, 0, 0, 0, 0, sigs, {from: txSender})
        utils.logGasUsage(subject, tx)

        let executeDataUsedSignatures = gnosisSafe.contract.execTransaction32785586.getData(to, value, data, operation, 0, 0, 0, 0, 0, sigs)
